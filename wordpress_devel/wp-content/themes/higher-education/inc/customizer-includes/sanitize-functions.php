 ...
 */
function higher_education_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function higher_education_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Higher Education 0.1
 */
function higher_education_sanitize_page( $input ) {
 ...
 * @since Higher Education 0.1
 */
function higher_education_sanitize_category_list( $input, $setting ) {
 ...
 *                    the setting default.
 */
function higher_education_sanitize_number_range( $number, $setting ) {
 ...
 * @since Higher Education 0.1
 */
function higher_education_sanitize_footer_code( $input ) {
 ...
 */
function higher_education_sanitize_select( $input, $setting ) {
	// Get list of choices from the control associated with the setting.
 ...
 * @since Higher Education 0.1
 */
function higher_education_sanitize_important_link() {
	return false;
}
